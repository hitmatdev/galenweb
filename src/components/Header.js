...
import { ChevronDownIcon, DocumentChartBarIcon, PhoneIcon, PlayCircleIcon } from '@heroicons/react/20/solid'
...
export default function Example() {
  ...
  <script type="text/javascript" id="hs-script-loader" async defer src="//js-na1.hs-scripts.com/40091071.js"></script>

      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Galen</span>
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-indigo-900 hover:bg-gray-100"
                    >
